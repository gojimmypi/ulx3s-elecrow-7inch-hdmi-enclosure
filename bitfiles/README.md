...
- [passthru_implementation_12F.bit](./passthru_implementation_12F.bit) from [ulx3s-examples](https://github.com/ulx3s/ulx3s-examples/tree/master/bin). See ESP32 [passthru](https://github.com/ulx3s/ulx3s-examples/tree/master/passthru)
- [passthru_implementation_42F.bit](./passthru_implementation_45F.bit)
- [passthru_implementation_85F.bit](./passthru_implementation_85F.bit)
